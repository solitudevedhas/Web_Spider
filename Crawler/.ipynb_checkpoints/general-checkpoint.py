...
def create_database_dir(directory):
    ...
    if not os.path.exists(directory + '/Database' + '/MySQL'):os.makedirs(directory + '/Database' +  '/MySQL')
    if not os.path.exists(directory + '/Database' + '/SQLite'):os.makedirs(directory + '/Database' +  '/SQLite')
    if not os.path.exists(directory + '/Database' + '/PostGreSQL'):os.makedirs(directory + '/Database'  + '/PostGreSQL')
    if not os.path.exists(directory + '/Database' + '/Oracle'):os.makedirs(directory + '/Database' + '/Oracle')
    if not os.path.exists(directory + '/Database' + '/MongoDB'):os.makedirs(directory + '/Database' + '/MongoDB')    
